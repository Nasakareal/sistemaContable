                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('areas/create') }}" class="btn btn-primary">
                            <i class="fa-solid fa-plus"></i> Añadir Área
                        </a>
                    </div>
                </div>

                <div class="card-body">
                    <table id="areas" class="table table-striped table-bordered table-hover table-sm">
                        <thead>
                            <tr>
                                <th><center>#</center></th>
                            ...
                            @foreach ($areas as $index => $area)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a href="{{ route('areas.edit', $area->id) }}" class="btn btn-success btn-sm">
        ...
        $(document).ready(function () {
            $('#areas').DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(filtrado de _MAX_ áreas en total)",
