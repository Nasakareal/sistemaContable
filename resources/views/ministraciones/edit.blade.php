...
@section('title', 'Editar Ministración')

@section('content_header')
    <h1>Editar Ministración</h1>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Modifique los Datos de la Ministración</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('ministraciones.update', $ministracion->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha" id="fecha"
                                           ...
                                           value="{{ old('fecha', $ministracion->fecha) }}" required>
                                    @error('fecha')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="fondo_id" id="fondo_id"
                                        ...
                                        @foreach ($fondos as $fondo)
                                            <option value="{{ $fondo->id }}" {{ old('fondo_id', $ministracion->fondo_id) == $fondo->id ? 'selected' : '' }}>
                                                {{ $fondo->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unidad_responsable_id" id="unidad_responsable_id"
                                        ...
                                        @foreach ($unidades as $unidad)
                                            <option value="{{ $unidad->id }}" {{ old('unidad_responsable_id', $ministracion->unidad_responsable_id) == $unidad->id ? 'selected' : '' }}>
                                                {{ $unidad->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="partida_id" id="partida_id"
                                        ...
                                        @foreach ($partidas as $partida)
                                            <option value="{{ $partida->id }}" {{ old('partida_id', $ministracion->partida_id) == $partida->id ? 'selected' : '' }}>
                                                {{ $partida->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="importe" id="importe"
                                           ...
                                           value="{{ old('importe', $ministracion->importe) }}" required>
                                    @error('importe')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipo_gasto" id="tipo_gasto"
                                           ...
                                           value="{{ old('tipo_gasto', $ministracion->tipo_gasto) }}">
                                    @error('tipo_gasto')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                                      rows="3">{{ old('descripcion', $ministracion->descripcion) }}</textarea>
                            @error('descripcion')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="periodo" id="periodo" class="form-control"
                                           value="{{ old('periodo', $ministracion->periodo) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="observaciones" id="observaciones" class="form-control"
                                           value="{{ old('observaciones', $ministracion->observaciones) }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="{{ $campo }}" id="{{ $campo }}"
                                               class="form-control"
                                               value="{{ old($campo, $ministracion->$campo) }}">
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cuenta_bancaria_origen" id="cuenta_bancaria_origen"
                                           class="form-control"
                                           value="{{ old('cuenta_bancaria_origen', $ministracion->cuenta_bancaria_origen) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cuenta_aplicacion" id="cuenta_aplicacion"
                                           class="form-control"
                                           value="{{ old('cuenta_aplicacion', $ministracion->cuenta_aplicacion) }}">
                                </div>
                            </div>
                        </div>
