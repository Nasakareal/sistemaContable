            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('cuentas/create') }}" class="btn btn-primary">
                            <i class="fa-solid fa-plus"></i> Añadir Cuenta
                        </a>
                    </div>
                </div>
                    ...
                    <table id="cuentas" class="table table-striped table-bordered table-hover table-sm">
                        <thead>
                            <tr>
                                ...
                                <th><center>Fondo Asociado</center></th>
                        ...
                        <tbody>
                            @foreach ($cuentas as $index => $cuenta)
                                <tr>
                                    ...
                                    <td>{{ $cuenta->nombre }}</td>
                                    <td>{{ $cuenta->numero }}</td>
                                    <td>{{ $cuenta->fondo->nombre ?? 'Sin fondo' }}</td>
        ...
        $(document).ready(function () {
            $('#cuentas').DataTable({
                ...
                "language": {
                    ...
                    "infoFiltered": "(filtrado de _MAX_ cuentas en total)",
