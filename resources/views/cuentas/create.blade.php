        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Llene los Datos de la Cuenta</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" 
                                           ...
                                           value="{{ old('nombre') }}" placeholder="Ej: Cuenta General" required>
                                    @error('nombre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="numero" id="numero" 
                                           ...
                                           value="{{ old('numero') }}" placeholder="Ej: 1234567890" required>
                                    @error('numero')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
