...
@section('content_header')
    <h1>Editar Proyección Presupuestal</h1>
@stop
                                ...
                                <select name="cuenta_bancaria_id" id="cuenta_bancaria_id" 
                                    ...
                                    @foreach ($cuentas as $cuenta)
                                        <option value="{{ $cuenta->id }}" 
                                            {{ old('cuenta_bancaria_id', $proyeccion->cuenta_bancaria_id) == $cuenta->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="month" id="month" 
                                    ...
                                    @for ($m = 1; $m <= 12; $m++)
                                        <option value="{{ $m }}" 
                                            {{ old('month', $proyeccion->month) == $m ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="year" id="year" min="2020" max="2100"
                                       value="{{ old('year', $proyeccion->year) }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="monto" id="monto" step="0.01" min="0"
                                       value="{{ old('monto', $proyeccion->monto) }}"
