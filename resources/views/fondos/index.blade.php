                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('fondos/create') }}" class="btn btn-primary">
                            <i class="fa-solid fa-plus"></i> Añadir Fondo
                        </a>
                    </div>
                </div>
                            ...
                            @foreach ($fondos as $index => $fondo)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a href="{{ route('fondos.edit', $fondo->id) }}" class="btn btn-success btn-sm">
                                            <i class="fa-solid fa-pencil"></i> Editar
                                        </a>
                                        <form action="{{ route('fondos.destroy', $fondo->id) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
        ...
        $(document).ready(function () {
            $('#fondos').DataTable({
                ...
                "language": {
                    ...
                    "infoEmpty": "Mostrando 0 a 0 de 0 fondos",
                    "infoFiltered": "(filtrado de _MAX_ fondos en total)",
                    "lengthMenu": "Mostrar _MENU_ fondos",
